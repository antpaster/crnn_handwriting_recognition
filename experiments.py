...
projection_smoothed_gauss = gaussian_filter1d(binary_image_projection, sigma=3)
...
strict_abysses = [i for i in deep_abysses if is_strict_local_min(projection_smoothed, i, window=50, confidence=0.9)]
...
axes[0].imshow(binary_image, cmap='gray') # Specify cmap for grayscale images
